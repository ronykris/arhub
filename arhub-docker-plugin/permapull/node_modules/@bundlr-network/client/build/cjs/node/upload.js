...
class NodeUploader extends upload_1.default {
    ...
    uploadFolder(path, { batchSize = 10, keepDeleted = true, indexFile, interactivePreflight, logFunction, manifestTags, } = { batchSize: 10, keepDeleted: true }) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (yield (0, exports.checkPath)(manifestPath)) {
                ...
                try {
                    for (var _g = true, csvStream_1 = __asyncValues(csvStream), csvStream_1_1; csvStream_1_1 = yield csvStream_1.next(), _a = csvStream_1_1.done, !_a;) {
            ...
            let i = 0;
            try {
                for (var _h = true, _j = __asyncValues(this.walk(path)), _k; _k = yield _j.next(), _d = _k.done, !_d;) {
                    _f = _k.value;
                    _h = false;
                    try {
                        const f = _f;
            ...
            const zprice = (yield this.utils.getPrice(this.currency, 0)).multipliedBy(files.length);
            const price = (yield this.utils.getPrice(this.currency, total)).plus(zprice).toFixed(0);
    ...
    generateManifestFromCsv(path, nowRemoved, indexFile) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let firstValue = true;
            try {
                for (var _d = true, csvs_1 = __asyncValues(csvs), csvs_1_1; csvs_1_1 = yield csvs_1.next(), _a = csvs_1_1.done, !_a;) {
                    _c = csvs_1_1.value;
                    _d = false;
                    try {
                        const d = _c;
