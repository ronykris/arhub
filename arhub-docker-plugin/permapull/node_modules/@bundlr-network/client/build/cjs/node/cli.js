...
exports.program.version(bundlr_1.default.VERSION, "-v, --version", "Gets the current package version of the bundlr client");
...
exports.program
    ...
    try {
        ...
        const balance = yield bundlr.utils.getBalance(options.address);
...
exports.program
    ...
    try {
        ...
        const confirmed = yield confirmation(`Confirmation: withdraw ${amount} ${bundlr.currencyConfig.base[0]} from ${bundlr.api.config.host} (${yield bundlr.utils.getBundlerAddress(bundlr.currency)})?\n Y / N`);
        if (confirmed) {
...
exports.program
    ...
    try {
        ...
        const res = yield bundlr.uploadFile(file, { tags: tags !== null && tags !== void 0 ? tags : [] });
...
exports.program
    ...
    try {
        ...
        const confirmed = yield confirmation(`Confirmation: send ${amount} ${bundlr.currencyConfig.base[0]} (${bundlr.utils.unitConverter(amount).toFixed()} ${bundlr.currency}) to ${bundlr.api.config.host} (${yield bundlr.utils.getBundlerAddress(bundlr.currency)})?\n Y / N`);
        if (confirmed) {
            const tx = yield bundlr.fund(new bignumber_js_1.default(amount), options.multiplier);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!["balance", "price"].includes(operation)) {
            ...
            if (opts.wallet === "default") {
                ...
                if (opts.currency === "arweave" && (yield (0, upload_1.checkPath)("./wallet.json"))) {
