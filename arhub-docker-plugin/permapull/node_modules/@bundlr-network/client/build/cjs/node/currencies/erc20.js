...
class ERC20Config extends ethereum_1.default {
    ...
    getFee(amount, to) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // convert value
            const ctPrice = new bignumber_js_1.default(yield this.price()); // price for this currency
    ...
    getGas() {
        return __awaiter(this, void 0, void 0, function* () {
            return [new bignumber_js_1.default(yield (0, currency_1.getRedstonePrice)("ETH")), 1e18];
        });
    }
}
