...
class ChunkingUploader extends events_1.EventEmitter {
    ...
    runUpload(dataStream, transactionOpts) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let getres;
            if (!id) {
                getres = yield this.api.get(`/chunks/${this.currency}/-1/-1`, { headers });
                utils_1.default.checkAndThrow(getres, "Getting upload token");
                this.uploadID = id = getres.data.id;
            }
            else {
                getres = yield this.api.get(`/chunks/${this.currency}/${id}/-1`, { headers });
            ...
            if (!isTransaction) {
                tx = this.arbundles.createData("", this.currencyConfig.getSigner(), Object.assign(Object.assign({}, transactionOpts), { anchor: (_b = transactionOpts === null || transactionOpts === void 0 ? void 0 : transactionOpts.anchor) !== null && _b !== void 0 ? _b : crypto_1.default.randomBytes(32).toString("base64").slice(0, 32) }));
                const raw = tx.getRaw();
            ...
            if (!isTransaction) {
                ...
                const sigBytes = Buffer.from(yield this.currencyConfig.getSigner().sign(hash));
            ...
            const finishUpload = yield this.api.post(`/chunks/${this.currency}/${id}/-1`, null, {
                headers: Object.assign({ "Content-Type": "application/octet-stream" }, headers),
